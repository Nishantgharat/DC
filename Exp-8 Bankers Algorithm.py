...
# Enter the no. of resources for resource type R0: 1
# Enter the no. of resources for resource type R1: 2
# Enter the no. of resources for resource type R2: 3
# Enter the no. of resources for resource type R3: 2
# Enter the no. of resources for resource type R4: 3
#
#
# Enter the Max resources for Process:
# P0: 2
# P1: 1
# P2: 3
# P3: 2
# Enter the Alloc resources for Process:
# P0: 1
# P1: 1
# P2: 2
# P3: 1
